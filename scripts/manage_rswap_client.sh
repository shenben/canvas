...
swap_files=(
    "/users/id_17/canvas/shared_swapfile"
    # "${home_dir}/memcached_swapfile"
    # "${home_dir}/sparkTC_swapfile"
    # "${home_dir}/sparkLR_swapfile"
    # "${home_dir}/sparkKM_swapfile"
    )

SWAP_PARTITION_SIZE_GBs=("3" 
# "10" "32" "32" "32"
)
SWAP_PARTITION_SIZE_GB="3"
